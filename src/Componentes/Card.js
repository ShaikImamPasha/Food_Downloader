...
const Card=(props)=>{     //props is js object
    var {name,locality,areaName,costForTwo,cloudinaryImageId, cuisines,avgRating,id}=props?.data.info;
     ...
     return(
        ...
        <div className="flex  justify-around flex-col ml-1 w-64 mb-10 bg-gray-100 hover:bg-gray-200 rounded-3xl">
           <div className="flex items-center justify-center">
           <img loading="lazy" className="w-50 h-50 rounded-3xl" alt="loading" src={CDN_IMAGE_URL+cloudinaryImageId}/>
           </div>
